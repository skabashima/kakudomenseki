...
const CHAPTERS := [
	# ============ 中学受験レベル ============
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "石碑の角を埋める", "stage": "e1", "tier": 1, "expect": "三角形の角",
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "梁の角を伝える", "stage": "e4", "tier": 2, "expect": "折れ線",
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "鉄の輪を切る", "stage": "e8", "tier": 1, "expect": "円周の長さ",
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "畑の広さを出す", "stage": "e3", "tier": 1, "expect": "三角形の面積",
	...
	# ============ 高校受験レベル ============
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "斜辺を出す", "stage": "j5", "tier": 1, "expect": "斜辺",
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "円の中の角", "stage": "j3", "tier": 1, "expect": "円周角",
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "布の見積り", "stage": "j8", "tier": 1, "expect": "相似比",
	...
	# ============ 大学受験レベル ============
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "外接円の半径", "stage": "s2", "tier": 1, "expect": "外接円",
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "崖の上の土地", "stage": "s3", "tier": 1, "expect": "間の角",
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "石を敷く", "stage": "s8", "tier": 1, "expect": "放物線",
