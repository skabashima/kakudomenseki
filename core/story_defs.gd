...
const CHAPTERS := [
	# ============ 中学受験レベル ============
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "石碑の角を埋める", "stage": "e1", "tier": 1,
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "梁の角を伝える", "stage": "e4", "tier": 1,
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "鉄の輪を切る", "stage": "e8", "tier": 1,
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "畑の広さを出す", "stage": "e3", "tier": 1,
	...
	# ============ 高校受験レベル ============
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "斜辺を出す", "stage": "j5", "tier": 1,
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "円の中の角", "stage": "j3", "tier": 1,
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "布の見積り", "stage": "j8", "tier": 1,
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "崖の上の土地", "stage": "s3", "tier": 1,
	...
	},
	{
		...
		"scenes": [
			...
			{"type": "solve", "title": "石を敷く", "stage": "s8", "tier": 1,
