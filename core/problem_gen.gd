...
## 2 編構成: 角度編 / 面積編。stages は易しい順
## (中学受験 → 高校受験 → 大学受験)に並び、前のステージをクリアすると次が開く。
## ステージ ID の頭文字がレベルを表す: e=中学受験 / j=高校受験 / s=大学受験
const COURSES := [
	{
		"id": "kaku", "name": "角度編", "sub": "角度をきわめる ― 時計・平行線・円・三角比",
		"color": Color(0.78, 0.5, 0.16),
		"stages": [
			{"id": "e1", "title": "三角形の角", "desc": "内角の和は 180°"},
			{"id": "e4", "title": "平行線と角", "desc": "錯角・折れ線の角"},
			{"id": "e6", "title": "二等辺三角形", "desc": "底角は等しい"},
			{"id": "e11", "title": "時計の針の角", "desc": "長針と短針のつくる角"},
			{"id": "e7", "title": "多角形の角", "desc": "内角の和と正多角形"},
			{"id": "e17", "title": "正多角形と対角線", "desc": "対角線がつくる角(応用)"},
			{"id": "e12", "title": "ブーメラン形の角", "desc": "へこみの角 = 3 つの角の和(応用)"},
			{"id": "e13", "title": "折り返しの角", "desc": "紙を折ると角が移る(応用)"},
			{"id": "j1", "title": "対頂角と外角", "desc": "外角 = 残りの内角の和"},
			{"id": "j2", "title": "平行線と三角形", "desc": "角の総合問題"},
			{"id": "j11", "title": "星形の角", "desc": "とがった角の和は 180°"},
			{"id": "j3", "title": "円周角の定理", "desc": "中心角の半分"},
			{"id": "j4", "title": "円と接線", "desc": "内接四角形・接線の角"},
			{"id": "j12", "title": "弧の比と円周角", "desc": "円周角は弧に比例する"},
			{"id": "j17", "title": "作図でできる角", "desc": "垂直二等分線・二等分線・60°"},
			{"id": "s13", "title": "三角形の五心", "desc": "内心・外心・垂心・重心の角"},
			{"id": "s11", "title": "三角方程式", "desc": "sin・cos・tan から角度へ"},
			{"id": "s12", "title": "ベクトルのなす角", "desc": "cosθ = a・b ÷ |a||b|"},
			{"id": "s14", "title": "2 直線のなす角", "desc": "加法定理と三角関数の合成"},
			{"id": "s15", "title": "空間のなす角", "desc": "立方体・正四面体の中の角"},
		],
	},
	{
		...
		"stages": [
			...
			{"id": "e14", "title": "道の面積", "desc": "道を端に寄せる(応用)"},
			...
			{"id": "j18", "title": "多面体とオイラー", "desc": "頂点 − 辺 + 面 = 2"},
			...
			{"id": "s19", "title": "点と直線の距離", "desc": "|ax + by + c| ÷ √(a² + b²)"},
			{"id": "s20", "title": "円の方程式", "desc": "半径・弦・接線・軌跡"},
			{"id": "s23", "title": "領域と最大最小", "desc": "不等式の領域・線形計画法"},
			{"id": "s21", "title": "空間図形の体積", "desc": "四面体・正四面体・外接球"},
			{"id": "s24", "title": "空間ベクトルと平面", "desc": "2点間の距離・点と平面の距離"},
			{"id": "s8", "title": "放物線と直線", "desc": "6分の1公式"},
			{"id": "s9", "title": "2つの放物線", "desc": "囲まれた面積"},
			{"id": "s10", "title": "面積の総合問題", "desc": "sin・絶対値・放物線"},
			{"id": "s22", "title": "回転体と曲線", "desc": "回転体の体積・曲線の長さ"},
		],
	},
]

## ステージ ID からレベル名(e=中学受験 / j=高校受験 / s=大学受験)
static func level_name(stage_id: String) -> String:
	match stage_id[0]:
		"e": return "中学受験レベル"
		"j": return "高校受験レベル"
		_: return "大学受験レベル"
