...
| 5 | 直角の宝 | 直角をはさむ 2 辺 | a² + b² = c²(三平方) |
| 6 | 円周角のふしぎ | 円周上の席 | 円周角は中心角の半分 |
| 7 | 大きくすると | 相似比 | 面積比は相似比の 2 乗 |
| 8 | 外接円のひみつ | 円周上の頂点 | a ÷ sin A = 2R(正弦定理) |
| 9 | はさむ角と面積 | 2 辺のはさむ角 | 面積 = ½ × a × b × sin C |
| 10 | 放物線が囲む | 水面(直線)の高さ | 面積 = (交点の差)³ ÷ 6 |
...
core/
  ...
  story_figs.gd       ストーリーで使う図のスペック(measure と解説図)
...
scenes/
  ...
  story_select.gd/.tscn     ストーリーの章えらび(全10章・前の章で解放)
