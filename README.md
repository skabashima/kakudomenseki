...
本編とは**動詞を変えた**モード。本編が「図が出る → 公式を使って値を答える」なのに対し、
...
core/
  ...
  story_defs.gd       発見モードの章データと、動かす図のスペック
...
scenes/
  ...
  story.gd/.tscn            発見モード(図を動かして不変量を見つける)
...
tests/
  ...
  story_check.gd         発見モードの章データと角度の丸めの検証 (--headless 可)
